...
export class FlipDown {
  ...
  public now: any;
  public epoch: any;
  public countdownEnded: any;
  public hasEndedCallback: any;
  public element: any;
  public rotors: any;
  public rotorLeafFront: any;
  public rotorLeafRear: any;
  public rotorTops: any;
  public rotorBottoms: any;
  public countdown: any;
  public daysRemaining: any;
  public clockValues: any;
  public clockStrings: any;
  public clockValuesAsString: any;
  public prevClockValuesAsString: any;
  public opts: any;
  public daysremaining: any;
  public rotorTop: any;
  public rotorBottom: any;

  public enableLogging = false;
  public hideDays: boolean;
  ...
  _parseOptions(opt: any): any {
    ...
    this.enableLogging = opt && opt.enableLogging;
    this.hideDays = opt && opt.hideDays;
    return {
      // Theme
  ...
  _setOptions(): void {
    // Apply theme
    if(this.element != null && 'classList' in this.element)
   ...
   * @param rotorIndex
   */
  _createRotorGroup(rotors, rotorIndex): HTMLElement {
  ...
  _createRotor(v = 0): HTMLElement {
    ...
    rotorLeafRear.textContent = String(v);
    rotorTop.textContent = String(v);
    rotorBottom.textContent = String(v);
   ...
   */
  _updateClockValues(init: boolean = false): void {
    ...
    if (this.hideDays) {
      ...
      let hours = this.clockValues.h + (this.clockValues.d * 24);
      hours = hours >= 99 ? 99 : hours;
      this.clockStrings.h = pad(hours, 2);
    }
    ...
    function rotorTopFlip(): void {
      if(this.rotorTop !== undefined){
    ...
    function rotorLeafRearFlip(): void {
 ...
 * @param children
 */
function appendChildren(parent, children): void {
  children.forEach((el) => {
